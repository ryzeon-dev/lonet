<p align="center">
<img alt="Version Badge" src="https://img.shields.io/badge/dev--version-v2.2.0-16a085">
<img alt="Version Badge" src="https://img.shields.io/badge/release-v2.2.0-16a085">
...
### Install DEB package
```commandline
wget https://github.com/ryzeon-dev/lonet/releases/download/v2.2.0/lonet_2.2.0_amd64.deb && sudo dpkg -i ./lonet_*_amd64.deb 
```
